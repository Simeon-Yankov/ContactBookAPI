...
public class GetPersonTests : BaseTestFixture
{
    ...
    public async Task ShouldReturnPerson_WhenPersonExists()
    {
        ...
        var resultHomeAddress = result.Addresses.FirstOrDefault(a => a.AddressType == AddressType.Home.ToString());
        ...
        var resultBusinessAddress = result.Addresses.FirstOrDefault(a => a.AddressType == AddressType.Business.ToString());
    ...
    public async Task ShouldReturnCorrectAddressTypes()
    {
        ...
        // Assert
        result.Should().NotBeNull();
        result!.Addresses.Should().Contain(a => a.AddressType == AddressType.Home.ToString());
        result.Addresses.Should().Contain(a => a.AddressType == AddressType.Business.ToString());
    }
